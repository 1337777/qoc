...
(**MEMO: 
  ...
  短 :: 一些参数“p”参数化许多定义和引理“d”和“l”都可以打包成一个; 然后可以实例化该参数以产生实例化的定义和引理：“Q.d”和“Q.l”，其新名称以任何选择的前缀名称“Q”作为前缀 ......
  
  Short :: some parameter "p" which parametrizes many definitions and lemmas "d" and "l" may all be packaged into one ; and then later this parameter may be instantiated to produce the instantiated definitions and lemmas : "Q.d" and "Q.l" whose new names are prefixed by any chosen prefix name "Q" ... 
*)
